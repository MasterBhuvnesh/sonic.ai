...
if __name__ == "__main__":
    ...
    ref_style = synthesiser.compute_style("Models/LibriTTS/Gavin.wav")

    # Generate speech
    audio = synthesiser.inference(
        text="Hey so what u are looking right now is a model i mean an ai model trained to step but we will be finetuning it in few voice so that we can make it talk in our voice",
        ref_s=ref_style,
    )
